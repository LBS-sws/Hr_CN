...
CREATE TABLE `hr_employee` (
  ...
  `address_code` int(10) DEFAULT NULL COMMENT '郵政編碼',
  `contact_address` varchar(255) NOT NULL COMMENT '通訊地址',
  `contact_address_code` int(10) DEFAULT NULL COMMENT '郵政編碼',
  ...
  `year_day` int(11) DEFAULT NULL COMMENT '年假',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='員工表';
