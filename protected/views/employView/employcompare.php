...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'staff_id',StaffFun::getCompanyListToCity($model->city,$model->staff_id),
            array('disabled'=>($readonly))
        ); ?>
    </div>
</div>
...
/*        echo $form->dropDownList($model, 'price1',WagesForm::getWagesList(),
    ...
    <?php if (DeptForm::getSalesTypeToId($model->department)==1): ?>
        ...
        <div class="col-sm-3 group_type">
            <?php echo $form->dropDownListCompare($oldModel,$model, 'group_type',StaffFun::getGroupTypeList(),
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'company_id',StaffFun::getCompanyListToCity($model->city,$model->company_id),
            array('disabled'=>($readonly))
        ); ?>
    </div>
    <!--分割-->
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'contract_id',StaffFun::getContractListToCity($model->city,$model->contract_id),
            array('disabled'=>($readonly))
        ); ?>
    </div>
</div>
...
EOF;
    Yii::app()->clientScript->registerScript('employCompareForm',$js,CClientScript::POS_READY);
?>